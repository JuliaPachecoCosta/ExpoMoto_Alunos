...
<p align="center">
  <img src="Layout_motos.jpg" alt="Preview do Projeto ExpoMotos" width="100%">
</p>

## 💻 Sobre o Projeto

O **ExpoMotos** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma loja de motos fictícia, apresentando modelos, endereço, entre outros.
...
```bash
ExpoMotos/
├── Códigos/         # Pasta com os códigos para a construção do site    
